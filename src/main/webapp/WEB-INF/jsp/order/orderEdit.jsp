    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="well">
                ...
                <input type="hidden" name="ORD_MST_IDX" id="ORD_MST_IDX" class="form-control" value="<c:out value="${commandMap.ORD_MST_IDX}" />"/>
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="text" name="MEM_MST_CD" id="MEM_MST_CD" class="form-control" value="<c:out value="${orderInfo.MEM_MST_CD}" />" readonly="readonly"/>
                            <input type="hidden" name="MEM_MST_IDX" id="MEM_MST_IDX" class="form-control" value="<c:out value="${orderInfo.MEM_MST_IDX}" />"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="text" name="MEM_MST_NM" id="MEM_MST_NM" class="form-control" value="<c:out value="${orderInfo.MEM_MST_NM}" />" readonly="readonly"/>
                        </div>
                        <label for="ORD_MST_WDP" class="col-lg-2 control-label"><spring:message code="common.title.wedding.planne" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_WDP" id="ORD_MST_WDP" class="form-control" value="<c:out value="${orderInfo.ORD_MST_WDP}" />" maxlength="20"/>
                        </div>                        
                    </div>
                    <div class="form-group">
                        <label for="MEM_MST_TEL" class="col-lg-2 control-label"><spring:message code="common.title.hp" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="MEM_MST_TEL" id="MEM_MST_TEL" class="form-control" value="<c:out value="${orderInfo.MEM_MST_TEL}" />" readonly="readonly"/>
                        </div>
                        <label for="MEM_MST_WED" class="col-lg-2 control-label"><spring:message code="common.title.wedding.date" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="MEM_MST_WED" id="MEM_MST_WED" class="form-control" value="<ui:formatDate value="${orderInfo.MEM_MST_WED }" pattern="yyyy-MM-dd"/>" readonly="readonly"/>
                        </div>                        
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <select class="form-control" name="STR_MST_IDX" id="STR_MST_IDX">
                                <c:forEach var="row" items="${codes.STORE}" varStatus="i">
                                <option value="<c:out value="${row.CMN_COM_IDX}" />" <c:if test="${row.CMN_COM_IDX eq orderInfo.STR_MST_IDX}"> selected="selected"</c:if>><c:out value="${row.CMN_COM_NM}" /></option>
                                </c:forEach>
                            </select>                            
                        </div>                        
                    </div>    
                    <div class="form-group">
                        ...
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_JK" id="ORD_MST_JK" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_JK}" />" maxlength="2"/>
                        </div>
                        <label for="ORD_MST_P" class="col-lg-1 control-label">P</label>
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_P" id="ORD_MST_P" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_P}" />" maxlength="2"/>
                        </div>
                        <label for="ORD_MST_V" class="col-lg-1 control-label">V</label>
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_V" id="ORD_MST_V" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_V}" />" maxlength="2"/>
                        </div>
                        <label for="ORD_MST_Y" class="col-lg-1 control-label">Y</label>
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_Y" id="ORD_MST_Y" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_Y}" />" maxlength="2"/>
                        </div>                        
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_C" id="ORD_MST_C" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_C}" />" maxlength="2"/>
                        </div>
                        <label for="ORD_MST_SC" class="col-lg-1 control-label">SC</label>
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_SC" id="ORD_MST_SC" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_SC}" />" maxlength="2"/>
                        </div>
                        <label for="ORD_MST_SH" class="col-lg-1 control-label">SH</label>
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_SH" id="ORD_MST_SH" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_SH}" />" maxlength="2"/>
                        </div>
                        <label for="ORD_MST_O" class="col-lg-1 control-label">O</label>
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_O" id="ORD_MST_O" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_O}" />" maxlength="2"/>
                        </div>                        
                    </div> 
                    <div class="form-group">
                        ...
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_NKT" id="ORD_MST_NKT" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_NKT}" />" maxlength="2"/>
                        </div>
                        <label for="ORD_MST_BWT" class="col-lg-1 control-label"><spring:message code="common.title.bow.tie" /></label>
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_BWT" id="ORD_MST_BWT" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_BWT}" />" maxlength="2"/>
                        </div>
                        <label for="ORD_MST_HKC" class="col-lg-1 control-label"><spring:message code="common.title.haenggeochip" /></label>
                        <div class="col-lg-1">
                            <input type="text" name="ORD_MST_HKC" id="ORD_MST_HKC" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_HKC}" />" maxlength="2"/>
                        </div>
                    </div> 
                    <div class="form-group">
                        <label class="col-lg-2 control-label"></label>
                        ...
                        <div class="col-lg-7">
                            <input type="text" name="ORD_MST_SVC_ETC" id="ORD_MST_SVC_ETC" class="form-control" value="<c:out value="${orderInfo.ORD_MST_SVC_ETC}" />" maxlength="20"/>
                        </div>                        
                    </div>                     
                    <div class="form-group">
                        <label for="ORD_MST_ORD_DT" class="col-lg-2 control-label"><spring:message code="common.title.order.date" /></label>
                        <div class="col-lg-3 input-group">
                            <input type="text" name="ORD_MST_ORD_DT" class="form-control datepicker" value="<ui:formatDate value="${orderInfo.ORD_MST_ORD_DT }" pattern="yyyy-MM-dd"/>" readonly="readonly"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="ORD_MST_RLS_DT" class="col-lg-2 control-label"><spring:message code="common.title.release.date" /></label>
                        <div class="col-lg-3 input-group">
                            <input type="text" name="ORD_MST_RLS_DT" class="form-control datepicker" value="<ui:formatDate value="${orderInfo.ORD_MST_RLS_DT }" pattern="yyyy-MM-dd"/>" readonly="readonly"/>
                        </div>                        
                    </div>   
                    <div class="form-group">
                        <label for="ORD_MST_PIK_DT" class="col-lg-2 control-label"><spring:message code="common.title.pickup.date" /></label>
                        <div class="col-lg-3 input-group">
                            <input type="text" name="ORD_MST_PIK_DT" class="form-control datepicker" value="<ui:formatDate value="${orderInfo.ORD_MST_PIK_DT }" pattern="yyyy-MM-dd"/>" readonly="readonly"/>
                        </div>                        
                    </div>  
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                                <select class="form-control" name="ORD_MST_ORD_STE" id="ORD_MST_ORD_STE">
                                    ...
                                    <option value="<c:out value="${row.CMN_COM_IDX}" />" <c:if test="${row.CMN_COM_IDX eq orderInfo.ORD_MST_ORD_STE}"> selected="selected"</c:if>><c:out value="${row.CMN_COM_NM}" /></option>
                                    </c:forEach>
                                </select>                                     
                        </div>                        
                    </div>                      
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_SAL" id="ORD_MST_SAL" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_SAL}" />"  maxlength="9"/>
                        </div>
                        <label for="ORD_MST_BAL" class="col-lg-2 control-label"><spring:message code="common.title.balance" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_BAL" id="ORD_MST_BAL" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_BAL}" />"  maxlength="9"/>
                        </div>                        
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <div class="radio">
                                <label><input type="radio" name="ORD_MST_GIV_YN" id="ORD_MST_GIV_YN1" value="N" <c:if test="${orderInfo.ORD_MST_GIV_YN eq 'N' }">checked="checked"</c:if>/><spring:message code="common.title.non.give" /></label>
                                <label><input type="radio" name="ORD_MST_GIV_YN" id="ORD_MST_GIV_YN2" value="Y" <c:if test="${orderInfo.ORD_MST_GIV_YN eq 'Y' }">checked="checked"</c:if>/><spring:message code="common.title.give" /></label>
                            </div>
                        </div>
                    </div>                    
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_CSH" id="ORD_MST_CSH" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_CSH}" />"  maxlength="9"/>
                        </div>
                        <label for="ORD_MST_CRD" class="col-lg-2 control-label"><spring:message code="common.title.card" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_CRD" id="ORD_MST_CRD" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_CRD}" />"  maxlength="9"/>
                        </div>                        
                    </div>
                    <div class="form-group">
                        <label for="ORD_MST_WXN" class="col-lg-2 control-label"><spring:message code="common.title.weixin" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_WXN" id="ORD_MST_WXN" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_WXN}" />"  maxlength="9"/>
                        </div>
                        <label for="ORD_MST_ZFU" class="col-lg-2 control-label"><spring:message code="common.title.jjeupu" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_ZFU" id="ORD_MST_ZFU" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_ZFU}" />"  maxlength="9"/>
                        </div>                        
                    </div>
                    <div class="form-group">
                        <label for="ORD_MST_DZH" class="col-lg-2 control-label"><spring:message code="common.title.ttajung" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_DZH" id="ORD_MST_DZH" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_DZH}" />"  maxlength="9"/>
                        </div>
                        <label for="ORD_MST_HBH" class="col-lg-2 control-label"><spring:message code="common.title.honbooe" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_HBH" id="ORD_MST_HBH" class="form-control number" value="<c:out value="${orderInfo.ORD_MST_HBH}" />"  maxlength="9"/>
                        </div>                        
                    </div>
                    <div class="form-group">
                        <label for="ORD_MST_PAY_ETC" class="col-lg-2 control-label"><spring:message code="common.title.etc" /></label>
                        <div class="col-lg-3">
                            <input type="text" name="ORD_MST_PAY_ETC" id="ORD_MST_PAY_ETC" class="form-control" value="<c:out value="${orderInfo.ORD_MST_PAY_ETC}" />"  maxlength="9"/>
                        </div>
                    </div>                    
                    <div class="form-group">
                        <label for="ORD_MST_ETC" class="col-lg-2 control-label"><spring:message code="common.title.note" /></label>
                        <div class="col-lg-8">
                            <textarea name="ORD_MST_ETC" id="ORD_MST_ETC" class="form-control" rows="5" maxlength="500"><c:out value="${orderInfo.ORD_MST_ETC}" /></textarea>
                        </div>
                    </div>
                    <div class="form-group text-right">
                        <div class="col-lg-10 col-lg-offset-2">
                            <a href="javascript:goList();" class="btn btn-primary"><spring:message code="common.btn.list"/></a>
                            <a href="javascript:goRemove();" class="btn btn-danger"><spring:message code="common.btn.delete"/></a>
                            <a href="javascript:goUpdate();" class="btn btn-info"><spring:message code="common.btn.save"/></a>
                        </div>
                    </div>
                </fieldset>
                </form>
...
$(function(){
    ...
    setMemberInfo = function (MEM_MST_IDX, MEM_MST_CD, MEM_MST_NM, MEM_MST_TEL, MEM_MST_WED, ADM_MST_ID, COM_INF_IDX ) {
...
//             , ORD_MST_PIK_DT: {required:"<spring:message code="common.title.pickup.date" /><spring:message code="common.validate.input" /> "}
    ...
    goRemove = function () {
    	if (confirm("<spring:message code="common.alert.confirm.delete" />")) {
            $dataForm.attr({"action":"<c:out value="${serverDomain}"/>/order/orderRemove.do", "method":"post", "target":"_self"}).submit();
        }
    };
    ...
    goUpdate = function () {
        if ($dataForm.valid()) {
            if (confirm("<spring:message code="common.alert.confirm.save" />")) {
                $dataForm.attr({"action":"<c:out value="${serverDomain}"/>/order/updateOrder.do", "method":"post", "target":"_self"}).submit();
            }           
        }
    };
});
