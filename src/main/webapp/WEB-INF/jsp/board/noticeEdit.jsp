    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="well">
                ...
                <input type="hidden" name="BRD_NTS_IDX" value="<c:out value="${info.BRD_NTS_IDX }"/>" />
                <input type="hidden" name="cPage" value="<c:out value="${commandMap.cPage }"/>" />
                <input type="hidden" name="searchStartDate" value="<c:out value="${commandMap.searchStartDate }"/>" />
                <input type="hidden" name="searchEndDate" value="<c:out value="${commandMap.searchEndDate }"/>" />
                <input type="hidden" name="searchBrdNtsTitle" value="<c:out value="${commandMap.searchBrdNtsTitle }"/>" />
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="BRD_NTS_TITLE" id="BRD_NTS_TITLE" class="form-control" value="<c:out value="${info.BRD_NTS_TITLE }"/>" maxlength="70"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="BRD_NTS_CONTENTS" class="col-lg-2 control-label"><spring:message code="common.title.content" /></label>
                        <div class="col-lg-8">
                            <textarea name="BRD_NTS_CONTENTS" id="BRD_NTS_CONTENTS" class="form-control" rows="10"><c:out value="${info.BRD_NTS_CONTENTS }"/></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control" name="STR_MST_IDX" id="STR_MST_IDX">
                                <option value="0" <c:if test="${row.STR_MST_IDX eq '0' }">selected="selected"</c:if>><spring:message code="common.title.shop.all.name" /></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label><input type="radio" name="BRD_NTS_TOP_YN" id="BRD_NTS_TOP_YN1" value="Y" <c:if test="${info.BRD_NTS_TOP_YN eq 'Y' }">checked="checked"</c:if>/><spring:message code="common.title.use" /></label>
                                <label><input type="radio" name="BRD_NTS_TOP_YN" id="BRD_NTS_TOP_YN2" value="N" <c:if test="${info.BRD_NTS_TOP_YN eq 'N' }">checked="checked"</c:if>/><spring:message code="common.title.nonuse" /></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label><input type="radio" name="BRD_NTS_USE_YN" id="BRD_NTS_USE_YN1" value="Y" <c:if test="${info.BRD_NTS_USE_YN eq 'Y' }">checked="checked"</c:if>/><spring:message code="common.title.use" /></label>
                                <label><input type="radio" name="BRD_NTS_USE_YN" id="BRD_NTS_USE_YN2" value="N" <c:if test="${info.BRD_NTS_USE_YN eq 'N' }">checked="checked"</c:if>/><spring:message code="common.title.nonuse" /></label>
                            </div>
                        </div>
                    </div>
    ...
    goModify = function () {
        if ($dataForm.valid()) {
            if (confirm("<spring:message code="common.alert.confirm.save" />")) {
                $dataForm.attr({"action":"<c:out value="${serverDomain}"/>/board/noticeModify.do", "method":"post", "target":"_self"}).submit();
            }           
        }
    };
    </c:if>
