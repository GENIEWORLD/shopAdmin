            ...
            <div class="well">
                ...
                <legend><spring:message code="common.btn.create"/></legend>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="COM_INF_NM" id="COM_INF_NM" class="form-control" value="" maxlength="20"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="COM_INF_CMS" class="col-lg-2 control-label"><spring:message code="common.title.commission"/></label>
                        <div class="col-lg-8">
                            <input type="text" name="COM_INF_CMS" id="COM_INF_CMS" class="form-control" value="" maxlength="5"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label><input type="radio" name=COM_INF_YN id="COM_INF_YN1" value="Y" checked="checked"/><spring:message code="common.title.use"/></label>
                            </div>
                            <div class="radio">
                                <label><input type="radio" name="COM_INF_YN" id="COM_INF_YN2" value="N" /><spring:message code="common.title.nonuse"/></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
	...
	goRegist = function () {
		if ($dataForm.valid()) {
			if (confirm("<spring:message code="common.alert.confirm.save" />")) {
			    $dataForm.attr({"action":"<c:out value="${serverDomain}"/>/employee/vendorRegist.do", "method":"post", "target":"_self"}).submit();
			}
		}
	};
});
