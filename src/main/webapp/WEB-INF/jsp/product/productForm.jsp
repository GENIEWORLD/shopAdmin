            ...
            <div class="well">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="PRD_MST_NM" class="col-lg-2 text-right"><spring:message code="common.title.product.name" /></label>
                        <div class="col-lg-8">
                            <input type="text" name="PRD_MST_NM" id="PRD_MST_NM" class="form-control" value="" maxlength="30"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="PRD_MST_CPN" id="PRD_MST_CPN" class="form-control" value="" maxlength="30"/>
                        </div>
                    </div>
    ...
    goRegist = function () {
        if ($dataForm.valid()) {
            if (confirm("<spring:message code="common.alert.confirm.save" />")) {
                $dataForm.attr({"action":"<c:out value="${serverDomain}"/>/product/productRegist.do", "method":"post", "target":"_self"}).submit();
            }           
        }
    };
});
