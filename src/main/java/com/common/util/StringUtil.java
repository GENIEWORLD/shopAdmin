...
/**
     ...
     * 1. MethodName : getInt
     * 2. ClassName  : StringUtil.java
     * 3. Comment    : 숫자형으로 변환, Null이거나 0이면 기본값 세팅
     * </pre>
     *
     * @param commandMap
     * @param key
     ...
     * @return
     */
    public static int getInt(Map<String, Object> commandMap, String key, int defNum) {
        return StringUtil.getInt(commandMap.get(key), defNum);
    }
     ...
     * 1. MethodName : getString
     * 2. ClassName  : StringUtil.java
     * 3. Comment    : 문자열으로 변환, Null이거나 ""이면 기본값 세팅
     * </pre>
     *
     * @param commandMap
     * @param key
     ...
     * @return
     */
    public static String getString(Map<String, Object> commandMap, String key, String defStr) {
        return StringUtil.getString(commandMap.get(key), defStr);
    }
